...
// Move all schema/type exports to the module scope (top of file)
...
if (import.meta.url === `file://${process.argv[1]}`) {
  async function main() {
    ...
    async function main() {
      ...
      function createUnifiedDiff(originalContent: string, newContent: string, filepath: string = "file") {
...
} // <-- Close the if (typeof require !== 'undefined' && require.main === module) block
